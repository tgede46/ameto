    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adresse', models.CharField(blank=True, max_length=255, verbose_name='Adresse postale')),
                ('actif', models.BooleanField(default=True, verbose_name='Compte actif')),
                ('role', models.CharField(choices=[('ADMIN', 'Administrateur'), ('PROPRIETAIRE', 'Propriétaire'), ('LOCATAIRE', 'Locataire')], default='LOCATAIRE', max_length=20, verbose_name='Rôle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personne_a_prevenir', models.CharField(blank=True, help_text='Nom et contact du garant ou de la personne à prévenir', max_length=255, verbose_name='Personne à prévenir (garant)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('utilisateur_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('nobre_logement', models.PositiveIntegerField(default=0, help_text='Peut être calculé dynamiquement à partir des biens associés', verbose_name='Nombre de logements')),
            ],
            options={
