    ...
    <div className="h-[calc(100vh-140px)] flex gap-6 animate-fade-in">
      ...
      <aside className="w-80 flex flex-col bg-white rounded-[32px] border border-gray-100 shadow-xl overflow-hidden">
        <div className="p-6 border-b border-gray-50">
          <h2 className="text-xl font-black text-gray-900 mb-4 tracking-tight">Support & Clients</h2>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2">
          {filteredConversations.length === 0 ? (
            <p className="text-center text-gray-400 text-sm mt-10 font-bold px-4">Aucun utilisateur trouvé.</p>
          ) : (
        ...
        {activeConversation ? (
            ...
            <div className="p-6 border-b border-gray-50 flex justify-between items-center bg-white/80 backdrop-blur-md sticky top-0 z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-brand-500 uppercase tracking-widest">{activeConvData?.other_user_role || 'Utilisateur'}</p>
                </div>
              </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
            ...
            <p className="text-gray-500 mt-2 max-w-xs mx-auto">
              Sélectionnez un utilisateur pour répondre à ses questions ou l'assister.
            </p>
          </div>
        )}
      </section>
